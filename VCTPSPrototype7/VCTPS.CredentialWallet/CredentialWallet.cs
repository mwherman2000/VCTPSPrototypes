...
namespace VCTPS.CredentialWallet
{
    public static class WalletHelpers
    {
        ...
        public static Dictionary<string, BTT_InvoiceLine_SealedEnvelope> ItemCatalog = new Dictionary<string, BTT_InvoiceLine_SealedEnvelope>();
        public static Dictionary<string, BTT_Party_SealedEnvelope> PartyDirectory = new Dictionary<string, BTT_Party_SealedEnvelope>();
        public static Dictionary<string, BTT_Invoice_SealedEnvelope> InvoiceJournal = new Dictionary<string, BTT_Invoice_SealedEnvelope>();
        ...
        public static string FindKey(string name, RegistryType type)
        {
            ...
            switch (type)
            {
                case RegistryType.Item:
                    {
                        foreach (BTT_InvoiceLine_SealedEnvelope ss in ItemCatalog.Values)
                        {
                            BTT_InvoiceLine_Claims claims = (BTT_InvoiceLine_Claims)ss.envelope.content.claims;
                ...
                case RegistryType.Party:
                    {
                        foreach (BTT_Party_SealedEnvelope ss in PartyDirectory.Values)
                        {
                            BTT_Party_Claims claims = (BTT_Party_Claims)ss.envelope.content.claims;
                ...
                case RegistryType.Invoice:
                    {
                        foreach (BTT_Invoice_SealedEnvelope ss in InvoiceJournal.Values)
                        {
                            BTT_Invoice_Claims claims = (BTT_Invoice_Claims)ss.envelope.content.claims;
        ...
        {
            {
                ...
                BTT_InvoiceLine_Claims subject_claims = UBL22CredentialFactory.NewItemClaims(
                    subject.Name,
                ...
                BTT_InvoiceLine_SealedEnvelope subject_credential = UBL22CredentialFactory.NewItemCredential(udid, vca, subject_claims, proofSk, DefaultNonce64);
        ...
        public static void InitializeParties()
        {
            // "Mary's Market Garden
            {
                ...
                BTT_Party_Claims subject_claims = UBL22CredentialFactory.NewPartyClaims(
                    new Cbc_SchemeCode("1234", "1234", "1234"),
                ...
                BTT_Party_SealedEnvelope subject_credential = UBL22CredentialFactory.NewPartyCredential(udid, vca, subject_claims, proofSk, DefaultNonce64);
                string sealedEnvelopeJson = subject_credential.ToString();
        ...
        public static void InitializeBusinessDocuments()
        {
            // Create a sample Invoice from David's Cabbages to Bob Buyer at ABC Grocery
            {
                ...
                BTT_Party_Claims deliveryclaims = (BTT_Party_Claims)PartyDirectory[deliverykey].envelope.content.claims;
                ...
                BTT_Invoice_Claims subject_claims = UBL22CredentialFactory.NewInvoiceClaims(DateTime.UtcNow,
                ...
                BTT_Invoice_SealedEnvelope subject_credential = UBL22CredentialFactory.NewInvoiceCredential(udid, vca, subject_claims, proofSk, DefaultNonce64);
                string sealedEnvelopeJson = subject_credential.ToString();
